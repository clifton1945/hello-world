/**
 *  newMain_tests.js
 *  160811  0940  many little tests heading towards one composed:
...
// NOW compose the whole thing:: HTMLCollections -> fn(D_lmits) -> S_RClss_innerHTML
var fn = d_lmits => R.compose(_RClss_S_outerHTML(d_lmits), _L_S_outerHTMLs);// D_lmits -> L_ -> S_RClss
var lmits = {beg:0, nxt:5};
RET = fn(lmits)(HTMLCol_Spans);
