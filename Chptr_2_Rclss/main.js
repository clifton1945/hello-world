/**
 *  main.js
 *  160813  @1006 READY TO SET Elm.StyleObj
 *  NOTE:   READ Setting style in >>https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/style
...
t.ok(R.is(String, cur_div.innerHTML), 'cur_div IS an Object');
